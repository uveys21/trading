...
public abstract interface BinanceApiService {
     ...
     */
    @org.jetbrains.annotations.Nullable
    @retrofit2.http.GET(value = "fapi/v1/exchangeInfo")
    public abstract java.lang.Object getExchangeInfo(@org.jetbrains.annotations.NotNull
    kotlin.coroutines.Continuation<? super com.uveys.trader.data.dto.ExchangeInfoResponse> continuation);
}